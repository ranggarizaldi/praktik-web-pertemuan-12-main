...
<body class="bg-light">
    <div class="container mt-5 border rounded bg-white py-4 px-5 mb-5">
        <header class="header-title mb-4">
            <h1><a href="./index.php" style="text-decoration: none;"><span class="fw-normal text-dark">Sistem
                        Informasi</span> <span class="textprimary">Mahasiswa</span></a></h1>
            <hr>
        </header>
        <section>
            ...
            if (isset($_GET["message"])) {
                echo "<div class=\"alert alert-success my-
3\">" . $_GET["message"] . "</div>";
            }
            ?>
...
<form action=\"./update_mahasiswa.php\"
...
<form action=\"./delete_mahasiswa.php\"
method=\"post\"class=\"d-inline-block\">
<input type=\"hidden\" name=\"id\"
value=\"$data[id]\">
<input type=\"submit\" name=\"submit\"
value=\"Delete\"style=\"width:80px\"
class=\"btn btn-danger\">
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bun
